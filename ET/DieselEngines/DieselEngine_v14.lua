...
local et = osmose.Model 'DieselEngine_v14'
...
-- Version 1.4 --> Differences from Version 1
-- Same as 1.3 but with Exhaust gas as resource flow
...
et:addUnit('DieselEngine',{type='Utility', Fmin = 0.1, Fmax = 0.9, Cost1=0, Cost2='COST2', Cinv1='INV_FIX_AN', Cinv2='INV_VAR_AN', Power1=0, Power2=0, Impact1=0,Impact2=0})
et['DieselEngine']:addStreams{
    ...
    rs_engine_eg = rs{'ExhaustGas', 'out', 'QEG_MAX', a0='QEG_A0', a1='QEG_A1'},
    -- Input heat
