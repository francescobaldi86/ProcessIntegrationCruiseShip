...
-- DIFFERENCES FROM v2: 
-- The fuel efficiency is not constant, but defined using the relationship: 
        -- mdot_fuel = a1*Peng + a0 (1)
-- - The coefficients a0 and a1 for equation (1) define the nonlinear behavior, and vary for each of the three "sub-engines

-- DIFFERENCES FROM v3:
-- All heat flows are defined according to equation (1), and the corresponding coefficients are given
...
et:addUnit('DieselEngineL',{type='Utility', Fmin = 0.1, Fmax = 'LOAD_SHIFT_LM', Cost1=0, Cost2='COST2', Cinv1='INV_FIX_AN', Cinv2='INV_VAR_AN', Power1=0, Power2=0, Impact1=0,Impact2=0})
